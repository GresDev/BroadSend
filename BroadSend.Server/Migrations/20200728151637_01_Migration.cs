...
{
    public partial class _01_Migration : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Interval01Id = table.Column<int>(nullable: true),
                    Interval02Id = table.Column<int>(nullable: true),
                    Interval03Id = table.Column<int>(nullable: true),
                    Interval04Id = table.Column<int>(nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Schedules", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Schedules_Directors_Interval01Id",
                        column: x => x.Interval01Id,
                        principalTable: "Directors",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Schedules_Directors_Interval02Id",
                        column: x => x.Interval02Id,
                        principalTable: "Directors",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Schedules_Directors_Interval03Id",
                        column: x => x.Interval03Id,
                        principalTable: "Directors",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Schedules_Directors_Interval04Id",
                        column: x => x.Interval04Id,
                        principalTable: "Directors",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Ростовцева", "(Ростовцева) Чернявская  Светлана Германовна" },
                    { 2, "Рябочкина", "(Рябочкина) Гололобова Ольга Алексеевна" },
                    { 3, "Якушева", "(Якушева) Кайгородова Наталия Владимировна" },
                    { 4, "Антипов", "Антипов Василий Владимирович" },
                    { 5, "Бурсин", "Бурсин Кирилл Владимирович" },
                    { 6, "Бурсина", "Бурсина Мария Владимировна" },
                    { 7, "Игнатов", "Игнатов Сергей Юрьевич" },
                    { 8, "Котов", "Котов Николай Викторович" },
                    { 9, "Крылов", "Крылов Илья Сергеевич" },
                    { 10, "Кузнецов", "Кузнецов Сергей Александрович" },
                    { 11, "Кузьмина", "Кузьмина Наталья Алексеевна" },
                    { 12, "Лелякова", "Лелякова  Марина Георгиевна" },
                    { 13, "Селиванова", "Селиванова Наталья Викторовна" },
                    { 14, "Смирнов", "Смирнов Александр Геннадиевич" },
                    { 15, "Цернес", "Цернес Александр Владимирович" }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Schedules_Interval01Id",
                table: "Schedules",
                column: "Interval01Id");

            migrationBuilder.CreateIndex(
                name: "IX_Schedules_Interval02Id",
                table: "Schedules",
                column: "Interval02Id");

            migrationBuilder.CreateIndex(
                name: "IX_Schedules_Interval03Id",
                table: "Schedules",
                column: "Interval03Id");

            migrationBuilder.CreateIndex(
                name: "IX_Schedules_Interval04Id",
                table: "Schedules",
                column: "Interval04Id");
